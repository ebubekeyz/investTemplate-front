  ...
  const pack = [
    {
      ...
      color:
        'h-[27.5rem] w-80 rounded-xl grid place-items-center shadow-lg card hover:scale-110 transition duration-200 py-8',
    },
    {
      id: nanoid(),
      identity: 'plan2',
      ...
      color:
        'h-[30rem] w-80 rounded-xl grid bg-cyan-500 place-items-center shadow-lg card hover:scale-110 transition duration-200 py-8',
    },
    {
      id: nanoid(),
      identity: 'plan3',
    ...
    },
    {
      ...
      color:
        'h-[30rem] w-80 rounded-xl bg-cyan-500 grid place-items-center shadow-lg card hover:scale-110 transition duration-200 py-8',
    },
    {
      id: nanoid(),
      identity: 'plan6',
